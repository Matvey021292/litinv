...
function init() {
	...
	( jQuery )("#restart_button a").on("click",function(){
		( jQuery )("#vidget_results").fadeOut(400);
...
function btn_click (num) {
	...
	TweenLite.to(timer,15,{t:0,ease:Power0.easeIn, onComplete:function(){
		//line.anim.kill();
		( jQuery )("#vidget_results").fadeIn(400);		
...
( jQuery )(document).ready(function(){
        ...
        (jQuery)(".js-input-user").on("blur", function () {
            var t = +((jQuery)(this).val()) + ((jQuery)(this).val() * ((jQuery)(".js-input-percent").val() / 100));
            t = t.toFixed(2),  (jQuery)(".js-input-profit").val(t), (jQuery)(".alertMessage__price").text(t + " $")
        });
});